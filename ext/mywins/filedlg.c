/*
** $Id: filedlg.c,v 1.6 2003/12/04 09:43:41 weiym Exp $
** 
...
int OpenFileDialogEx (HWND hWnd, int lx, int ty, int w, int h, PFILEDLGDATA pfdi)
{
    ...
    int LstTY = 2*SPACE_HEIGHT+20;
    
    CTRLDATA WinFileCtrl [] =
    { 
/*      { "static", WS_VISIBLE | SS_LEFT,
            SPACE_WIDTH, SPACE_WIDTH, 80, GetSysCharHeight(), IDC_STATIC, "选择目录", 0 },
        { "static", WS_VISIBLE | SS_LEFT,
            SPACE_WIDTH+totalW*2/5, SPACE_WIDTH, 80, GetSysCharHeight(), IDC_STATIC, "选择文件", 0 },
        { "button", WS_VISIBLE | WS_TABSTOP ,
            SPACE_WIDTH+totalW*2/5+ 60, SPACE_WIDTH, 22, GetSysCharHeight(), IDC_HOME, "Hm", 0 },
*/
        { "button", WS_VISIBLE | WS_TABSTOP ,
