...
/* 
 * $Id: window.h,v 1.115 2003/09/29 02:52:46 snig Exp $
 *
 ...
 * \code
 * MSG_SHEETCMD
 * int param1 = (HWND)wParam;
 * int param2 = (int)lParam;
 * \endcode
 *
...
#define BKC_CONTROL_DEF             34
#define FGC_CONTROL_DEF             35

#define BKC_DESKTOP                 36

#define BKC_STATIC		            37
#define BKC_BUTTON		            38
#define BKC_DIALOG		            39
#define BKC_TIP			            40
#define FGC_MENUITEM_FRAME	        41

#define WEC_ITEM_NUMBER             42
...
#define SYSBMP_BGPICTURE        2

#define SYSBMP_ITEM_NUMBER      3
 ...
 *      - SYSBMP_BGPICTURE      Bitmap of the background picture.
 *
...
/**
 * \fn BOOL GUIAPI LoadSystemBitmap (PBITMAP pBitmap, const char* szItemName)
...
#define SYSBMP_BUTTON       "button"
#define SYSBMP_DOWNARROW    "downarrow"
#define SYSBMP_UPDOWNARROW  "updownarrow"
#define SYSBMP_CHECKMARK    "checkmark"
#define SYSBMP_IMECTRLBTN   "IMEctrlbtn"
#define SYSBMP_LOGO         "logo"
#define SYSBMP_SPINBOX      "spinbox"
...
/**
 * \fn BOOL GUIAPI SetTimerSpeed (HWND hWnd, int id, unsigned int speed)
 * \brief Adjusts a timer with a different timeout value.
 *
 * This function adjusts a timer with the specified timeout \a speed value.
 *
 * \param hWnd The window owns the timer.
 * \param id The identifier of the timer.
 ...
 * \sa SetTimer
 */
BOOL GUIAPI SetTimerSpeed (HWND hWnd, int id, unsigned int speed);
